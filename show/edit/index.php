...
<?php
            ...
            //echo '<script>(function() {var hash;hash = window.location.hash;console.log(hash);if (hash.length > 1) {window.location.replace(\'#\');setTimeout(function() {window.location.replace(hash)}, 10);};})();</script><body>'.$bodytext.'</body>';
